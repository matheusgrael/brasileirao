...
public class EquipeRepository {
    ...
    addEquipe(new Equipe(UUID.randomUUID(), "Vasco", LocalDate.of(1893,04,25),
        "RJ",5, 4, false));
    addEquipe(new Equipe(UUID.randomUUID(), "Cruzeiro", LocalDate.of(1906,01,29),
        "MG",10, 7, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Atético MG", LocalDate.of(1901,04,13),
        "MG",7, 4, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Santos", LocalDate.of(1890,06,16),
        "SP",9, 8, false));
    addEquipe(new Equipe(UUID.randomUUID(), "São Paulo", LocalDate.of(1914,07,02),
        "SP",8, 12, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Palmeiras", LocalDate.of(1911,04,01),
        "SP",15, 6, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Corinthians", LocalDate.of(1910,03,14),
        "SP",11, 4, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Internacional", LocalDate.of(1914,01,11),
        "RS",4, 7, true));
    addEquipe(new Equipe(UUID.randomUUID(), "Gremio", LocalDate.of(1902,05,04),
        "RS",8, 6, true));
    }
